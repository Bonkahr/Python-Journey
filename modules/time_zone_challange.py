...
print("PLease choose a timezone or zero(0) to Quit")
...
while True:
    ...
    if choice in available_zones.keys():
        ...
        print("The time in {} is {} {}".format(available_zones[choice],
                                               ...
                                               world_time.tzname()))
        print("Local time is {}".format(datetime.datetime.now().strftime(
            '%A%x%X')))
        print("UTC time is {}".format(datetime.datetime.utcnow().strftime(
            '%A%x%X')))
        print()
