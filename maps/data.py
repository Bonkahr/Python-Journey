...
Plant = namedtuple('Plant',
                   ['name', 'scientific_name', 'lifecycle', 'plant_type']
                   )
PlantDetails = namedtuple('PlantDetails', ['scientific_name',
                                           'lifecycle', 'plant_type'
                                           ]
                          )
...
plants_dict = {
    ...
    "Bellflower": PlantDetails("Campanula", "Annual, biennial, perennial",
                               "Flower"),
    ...
    "Golden Hakone Grass": PlantDetails("Hakonechloa macra", "Perennial",
                                        "Grass"),
    "Hydrangea": PlantDetails("Hydrangea", "Deciduous, evergreen", "Shrub"),
    "Iris": PlantDetails("Iris", "Perennial", "Flower"),
    "Japanese Camellia": PlantDetails("Camellia japonica", "Evergreen",
                                      "Shrub"),
