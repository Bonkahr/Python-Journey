...
def score_hand(hand):
    ...
    # only one ace can have the value 11, and this will be reduced to 1 if
    # the hand would bust
    score = 0
    ace = False
...
dealer_button = tkinter.Button(button_frame, text='Dealer',
                               command=deal_dealer)
dealer_button.grid(row=2, column=1, columnspan=3, sticky='w')

player_button = tkinter.Button(button_frame, text='Player', command=deal_player)
player_button.grid(row=3, column=3, columnspan=3, sticky='w')
